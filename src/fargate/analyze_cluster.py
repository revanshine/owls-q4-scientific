...
def main():
    ...
    distances = np.sqrt((pca_coords[:, 0] - target_x)**2 + (pca_coords[:, 1] - target_y)**2)
    ...
    print(f"\n💡 What This Tells Us:")
    print(f"   • These vectors have distinct semantic properties")
    print(f"   • They cluster together because they're similar to each other")
    print(f"   • But different enough from the main group to separate")
    print(f"   • This indicates rich, diverse embedding space")
