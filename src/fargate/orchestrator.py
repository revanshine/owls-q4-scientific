    ...
    try:
        ...
        for record in event["Records"]:
            ...
            if processing_mode in ["enhanced", "full"]:
                ...
                print(
                    f"🧬 Launching Fargate for scientific processing: {processing_mode}"
                )
                ...
                print("⚡ Standard processing mode - would use simple Lambda")
        ...
        return {
            "statusCode": 500,
            "body": json.dumps({"error": str(e), "orchestrator": "lambda_to_fargate"}),
        }
